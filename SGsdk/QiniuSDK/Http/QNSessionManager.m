...
- (void)sendRequest2:(NSMutableURLRequest *)request
   ...
   withProgressBlock:(QNInternalProgressBlock)progressBlock
    ...
    NSURLSessionUploadTask *uploadTask = [_httpManager uploadTaskWithRequest:request fromData:nil progress:nil completionHandler:^(NSURLResponse *response, id responseObject, NSError *error) {
