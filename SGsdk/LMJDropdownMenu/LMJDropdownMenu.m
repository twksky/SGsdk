...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    _arrowMark.center = _mainBtn.center;
...
- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight{
    ...
    _listView.frame = CGRectMake(171 , 63, 219,  0);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        [deleteBtn setBackgroundImage:[UIImage imageNamed:@"dropdownMenu_cornerIcon.png"] forState:UIControlStateNormal];
        CGFloat deleteBtnW = 15;
        CGFloat deleteBtnH = 15;
        deleteBtn.frame = CGRectMake(VIEW_WIDTH(_listView) - deleteBtnW, 7.5, deleteBtnW, deleteBtnH);
...
- (void)deleteBtnClick:(UIButton *)sender {
    ...
    [_titleArr removeObjectAtIndex:sender.tag];
    [_tableView reloadData];
    _tableView.frame = CGRectMake(VIEW_X(_tableView), VIEW_Y(_tableView), VIEW_WIDTH(_tableView), _tableView.contentSize.height);
